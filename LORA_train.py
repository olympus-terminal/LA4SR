#### Post-training using LORA [https://github.com/microsoft/LoRA]
#### A Mamba 2.8b model is used as an example
...
tokenizer = AutoTokenizer.from_pretrained("state-spaces/mamba-2.8b-hf", use_special_tokens=False)
